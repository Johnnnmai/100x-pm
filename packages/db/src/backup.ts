...
function resolveDefaultConfigPath(): string {
  return path.resolve(resolve100X PMHomeDir(), "instances", resolve100X PMInstanceId(), "config.json");
}
...
function resolveDefaultBackupDir(): string {
  return path.resolve(resolve100X PMHomeDir(), "instances", resolve100X PMInstanceId(), "data", "backups");
}
