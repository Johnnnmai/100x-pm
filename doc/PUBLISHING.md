...
Low-level reference for how 100X PM packages are built for npm.
...
The CLI package, `100x-pmai`, imports code from workspace packages such as:
...
- `npx 100x-pmai@canary onboard` can install them explicitly
- `npx 100x-pmai onboard` continues to resolve `latest`
