...
- installed adapter list for this 100X PM instance
...
## 8. New Skill: `100x-pm-create-agent`

Create new skill directory:

- `skills/100x-pm-create-agent/SKILL.md`
- `skills/100x-pm-create-agent/references/api-reference.md`
...
Also update `skills/100x-pm/SKILL.md` to reference this skill for hiring workflows.
...
- `100x-pm-create-agent` skill + docs updates
