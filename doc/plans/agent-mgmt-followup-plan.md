...
- `skills/100x-pm/SKILL.md` and `skills/100x-pm/references/api-reference.md` do not currently require markdown formatting quality for status comments (links, structure, readable updates).
...
## 6.2 `skills/100x-pm-create-agent/SKILL.md`
