...
name: design-guide
description: >
  100X PM UI design system guide for building consistent, reusable frontend
...
# 100X PM Design Guide

100X PM's UI is a professional-grade control plane — dense, keyboard-driven, dark-themed by default. Every pixel earns its place.
...
2. **Custom composites** (`ui/src/components/`) — StatusBadge, EntityRow, MetricCard, etc. These capture 100X PM-specific design language.
