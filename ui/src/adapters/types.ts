...
export type { TranscriptEntry, StdoutLineParser, CreateConfigValues } from "@100x-pmai/adapter-utils";
...
export interface UIAdapterModule {
  type: string;
  label: string;
  parseStdoutLine: (line: string, ts: string) => import("@100x-pmai/adapter-utils").TranscriptEntry[];
