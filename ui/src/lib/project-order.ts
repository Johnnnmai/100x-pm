import type { Project } from "@100x-pmai/shared";

export const PROJECT_ORDER_UPDATED_EVENT = "100x-pm:project-order-updated";
const PROJECT_ORDER_STORAGE_PREFIX = "100x-pm.projectOrder";
