...
import type { ActivityEvent } from "@100x-pmai/shared";
import type { Agent, IssueAttachment } from "@100x-pmai/shared";
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              <100X PM className="h-3.5 w-3.5 mr-1.5" />
      ...
      <Tabs value={detailTab} onValueChange={setDetailTab} className="space-y-3">
        ...
        <TabsContent value="comments">
          <CommentThread
            ...
            agentMap={agentMap}
            draftKey={`100x-pm:issue-comment-draft:${issue.id}`}
            enableReassign
