...
import { buildProjectMentionHref, parseProjectMentionHref } from "@100x-pmai/shared";
...
export const MarkdownEditor = forwardRef<MarkdownEditorRef, MarkdownEditorProps>(function MarkdownEditor({
    ...
    for (const node of links) {
      ...
      if (!parsed) {
        if (link.dataset.projectMention === "true") {
          ...
          link.classList.remove("100x-pm-project-mention-chip");
      ...
      link.classList.add("100x-pm-project-mention-chip");
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "relative 100x-pm-mdxeditor-scope",
    ...
    >
      <MDXEditor
        ...
        onBlur={() => onBlur?.()}
        className={cn("100x-pm-mdxeditor", !bordered && "100x-pm-mdxeditor--borderless")}
        contentEditableClassName={cn(
          "100x-pm-mdxeditor-content focus:outline-none [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5 [&_li]:list-item",
          contentClassName,
        )}
        plugins={plugins}
      />
