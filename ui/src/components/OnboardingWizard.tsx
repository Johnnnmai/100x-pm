...
import type { AdapterEnvironmentTestResult } from "@100x-pmai/shared";
...
} from "@100x-pmai/adapter-codex-local";
import { DEFAULT_CURSOR_LOCAL_MODEL } from "@100x-pmai/adapter-cursor-local";
import { DEFAULT_GEMINI_LOCAL_MODEL } from "@100x-pmai/adapter-gemini-local";
...
const DEFAULT_TASK_DESCRIPTION = `Setup yourself as the CEO. Use the ceo persona found here: [https://github.com/100x-pmai/companies/blob/main/default/ceo/AGENTS.md](https://github.com/100x-pmai/companies/blob/main/default/ceo/AGENTS.md)
                    ...
                    <div className="space-y-3">
                      <div>
                        <div className="flex items-center gap-1.5 mb-1">
                          ...
                          <HintIcon text="100X PM works best if you create a new folder for your agents to keep their memories and stay organized. Create a new folder and put the path here." />
                        </div>
