...
import { AGENT_ADAPTER_TYPES } from "@100x-pmai/shared";
import type {
  Agent,
...
// Canonical type lives in @100x-pmai/adapter-utils; re-exported here
// so existing imports from this file keep working.
export type { CreateConfigValues } from "@100x-pmai/adapter-utils";
import type { CreateConfigValues } from "@100x-pmai/adapter-utils";
