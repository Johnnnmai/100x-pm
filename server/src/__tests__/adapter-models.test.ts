...
import { models as codexFallbackModels } from "@100x-pmai/adapter-codex-local";
import { models as cursorFallbackModels } from "@100x-pmai/adapter-cursor-local";
import { resetOpenCodeModelsCacheForTests } from "@100x-pmai/adapter-opencode-local/server";
...
describe("adapter model listing", () => {
  ...
  it("returns no opencode models when opencode command is unavailable", async () => {
    process.env.PAPERCLIP_OPENCODE_COMMAND = "__100x-pm_missing_opencode_command__";
