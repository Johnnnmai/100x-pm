...
import type { AdapterRuntimeServiceReport } from "@100x-pmai/adapter-utils";
import type { Db } from "@100x-pmai/db";
import { workspaceRuntimeServices } from "@100x-pmai/db";
...
export async function realizeExecutionWorkspace(input: {
  ...
  const worktreeParentDir = configuredParentDir
    ...
    : path.join(repoRoot, ".100x-pm", "worktrees");
