...
import { agents as agentsTable, companies, heartbeatRuns } from "@100x-pmai/db";
...
import { runClaudeLogin } from "@100x-pmai/adapter-claude-local/server";
import {
...
import { ensureOpenCodeModelConfiguredAndAvailable } from "@100x-pmai/adapter-opencode-local/server";
