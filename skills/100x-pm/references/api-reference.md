# 100X PM API Reference

Detailed reference for the 100X PM control plane API. For the core heartbeat procedure and critical rules, see the main `SKILL.md`.
...
{
  "name": "100X PM Mobile App",
  "description": "Ship iOS + Android client",
  "status": "planned",
  "goalIds": ["{goalId}"],
  "workspace": {
    "name": "100x-pm-mobile",
    "cwd": "/Users/me/100x-pm-mobile",
    "repoUrl": "https://github.com/acme/100x-pm-mobile",
    "repoRef": "main",
    "isPrimary": true
  }
}
...
Use `100x-pm-create-agent` for the full hiring workflow (reflection + config comparison + prompt drafting).
