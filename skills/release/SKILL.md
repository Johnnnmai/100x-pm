...
name: release
description: >
  Coordinate a full 100X PM release across engineering verification, npm,
...
Run the full 100X PM release as a maintainer workflow, not just an npm publish.
...
7. If running through 100X PM, you have issue context for status updates and follow-up task creation.
...
100X PM now uses this release model:
...
```bash
npm view 100x-pmai@canary version
```
...
- any release summary in 100X PM issue context
