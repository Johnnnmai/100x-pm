...
description: >
  Create new agents in 100X PM with governance-aware hiring. Use when you need
  to inspect adapter configuration options, compare existing agent configs,
  draft a new agent prompt/config, and submit a hire request.
---

# 100X PM Create Agent Skill
...
2. Discover available adapter configuration docs for this 100X PM instance.
