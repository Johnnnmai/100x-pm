...
100X PM organizes autonomous AI work around five key concepts.
...
One 100X PM instance can run multiple companies.
...
Agents don't run continuously. They wake up in **heartbeats** — short execution windows triggered by 100X PM.
