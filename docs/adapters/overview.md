...
summary: What adapters are and how they connect agents to 100X PM
---

Adapters are the bridge between 100X PM's orchestration layer and agent runtimes. Each adapter knows how to invoke a specific type of AI agent and capture its results.

## How Adapters Work

When a heartbeat fires, 100X PM:
...
packages/adapters/<name>/
  src/
    ...
    cli/
      format-event.ts   # Terminal output for `100x-pmai run --watch`
```
