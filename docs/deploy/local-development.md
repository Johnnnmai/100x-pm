...
summary: Set up 100X PM for local development
---

Run 100X PM locally with zero external dependencies.
...
No Docker or external database required. 100X PM uses embedded PostgreSQL automatically.
