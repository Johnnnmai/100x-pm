...
100X PM exposes a RESTful JSON API for all control plane operations.
...
- Run audit trail: include `X-100X PM-Run-Id` header on all mutating requests during heartbeats
