...
export function secretsCheck(config: 100X PMConfig, configPath?: string): CheckResult {
  ...
  if (provider !== "local_encrypted") {
    return {
      ...
      canRepair: false,
      repairHint: "Run `100x-pmai configure --section secrets` and set provider to local_encrypted",
    };
  }
